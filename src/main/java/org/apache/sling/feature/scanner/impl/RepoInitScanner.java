...
public class RepoInitScanner implements ExtensionScanner {
    private static final MatchingRequirement REQUIREMENT_REPOINIT = new MatchingRequirementImpl(
            null,
            "osgi.implementation",
            Collections.singletonMap(
                    "filter", "(&(osgi.implementation=org.apache.sling.jcr.repoinit)(version>=1.0)(!(version>=2.0)))"),
            null);
