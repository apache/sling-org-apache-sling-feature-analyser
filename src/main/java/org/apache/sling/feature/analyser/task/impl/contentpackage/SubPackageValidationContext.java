...
public class SubPackageValidationContext extends ArchiveValidationContextImpl {
    ...
    public SubPackageValidationContext(ArchiveValidationContextImpl containerPackageContext, Archive archive, Path archivePath) throws IOException {
        super(archive, archivePath);
