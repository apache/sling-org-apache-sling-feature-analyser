...
public class CheckContentPackagesForInstallablesTest {
    ...
    @Test
    public void testEmptyContentPackage() throws Exception {
        final CheckContentPackageForInstallables analyser = new CheckContentPackageForInstallables();
        final AnalyserTaskContextImpl ctx = new AnalyserTaskContextImpl();
        ...
        final ContentPackageDescriptorImpl cpd = new ContentPackageDescriptorImpl(
                "content",
                new Artifact(ArtifactId.parse("g:c:1")),
                new URL("file:/foo"),
                null,
                null,
                null,
    ...
    @Test
    public void testEmbeddedContentPackage() throws Exception {
        final CheckContentPackageForInstallables analyser = new CheckContentPackageForInstallables();
        final AnalyserTaskContextImpl ctx = new AnalyserTaskContextImpl();
        ...
        final ContentPackageDescriptorImpl embedded = new ContentPackageDescriptorImpl(
                "embedded",
                new Artifact(ArtifactId.parse("g:e:1")),
                new URL("file:/foo"),
                null,
                null,
                null,
