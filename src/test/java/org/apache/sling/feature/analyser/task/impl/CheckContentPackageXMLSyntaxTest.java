...
public class CheckContentPackageXMLSyntaxTest {

    @Test 
    public void testContentPackageWithInvalidXMLShouldBeReported() throws Exception {
        final CheckContentPackageXMLSyntax analyser = new CheckContentPackageXMLSyntax();
        ...
        assertThat(errors.get(0), equalTo("Parse error in file jcr_root/apps/cschneidervalidation/configs/com.adobe.test.Invalid.xml : The reference to entity \"se\" must end with the ';' delimiter."));
    }
}
